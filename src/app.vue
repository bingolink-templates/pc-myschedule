    ...
    <div class="news">
        ...
        <div class="content">
            <div class="calendar">
              ...
              'color':(dt.isActive||dt.isHover)?'#FFFFFF':''}" @mouseover="dt.isHover=true" @mouseout="dt.isHover=false" @click="selectDay(dt)">{{dt.day}}</i>
                    </span>
                </div>
            </div>
            <div>
...
export default {
    ...
    methods: {
        ...
        toMore() {
            app.trigger('JumpToTabView', ['ScheduleView'])
